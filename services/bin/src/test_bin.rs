...
pub struct TestBinProgram;

impl sails_rs::client::Program for TestBinProgram {}
...
impl<E: sails_rs::client::GearEnv> TestBin for sails_rs::client::Actor<TestBinProgram, E> {
    type Env = E;
    fn test(&self) -> sails_rs::client::Service<test::TestImpl, Self::Env> {
...
pub trait TestBinCtors {
    type Env: sails_rs::client::GearEnv;
    #[allow(clippy::new_ret_no_self)]
    #[allow(clippy::wrong_self_convention)]
    fn new(self) -> sails_rs::client::PendingCtor<TestBinProgram, io::New, Self::Env>;
}

impl<E: sails_rs::client::GearEnv> TestBinCtors
    for sails_rs::client::Deployment<TestBinProgram, E>
{
    type Env = E;
    fn new(self) -> sails_rs::client::PendingCtor<TestBinProgram, io::New, Self::Env> {
        self.pending_ctor(())
